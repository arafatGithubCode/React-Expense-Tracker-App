      ...
      <div className="flex justify-start sm:justify-center items-center gap-5 mt-3 ml-2">
        ...
        <div className="w-[10%] relative group">
          <img
            ...
            alt="Image"
          />
          <div className="opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out absolute inset-x-0 bottom-[-1] flex justify-center items-start text-sm font-medium text-black">
